...
class AddComponent extends React.Component {
  ...
  checkAndFocus = (props) => {
    ...
    if (currentElem.elemId && id === currentElem.elemId) {
      ...
      //when focus is removed doesn't show the handle and the buttons
  ...
  handleInlineStyles = (type) => {
    const headerStyles = (type === 'Header2') ? '16px 0px 4px 0px' : ''
    return {
      margin: (type === 'Header1') ? '32px 0px 4px 0px' : headerStyles
    }
  }

  ...
  render() {
    return (
      ...
      >
        ...
        >
          <i className={cx("fa-light fa-trash-can")} />
        </div>
        <span className={cx("handle-icon")}><i className={cx("fa-regular fa-grip-dots-vertical")} /></span>
        <CSSTransition
          ...
          <React.Fragment>
            {
              ...
              <div className={cx("showmore-popup")} onClick={this.handleClick}>
                <div data-action="delete" className={cx("more-option")}>
                  <span><i className={cx("fa-light fa-trash-can")} /></span>
                  <span>Delete</span>
                </div>
              </div>
            }

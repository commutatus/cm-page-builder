...
var Header2 = exports.Header2 = function (_React$Component) {
  ...
  function Header2() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Header2.__proto__ || Object.getPrototypeOf(Header2)).call.apply(_ref, [this].concat(args))), _this), _this.state = {

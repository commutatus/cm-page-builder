...
var Header3 = exports.Header3 = function (_React$Component) {
  _inherits(Header3, _React$Component);
  ...
  function Header3() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Header3.__proto__ || Object.getPrototypeOf(Header3)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      styles: {}
